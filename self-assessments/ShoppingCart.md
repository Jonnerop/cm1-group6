...
I wasn't exactly sure how self-assessment wast to be made. So this turned out probably way too long and thorough. My Team was helpful as usual and easy to discuss with. It was good to witness that other team members struggle with similar parts as I (css). Coding along with your group while everyone is tackling similar obstacles was great learning experience and will probably become even more useful in the future. Everyone was able to focus and finish their tasks, altough configuring the css turned out very time consuming. This coding marathon helped me better understand the use of useState hook, extracting a separate element from an existing code, and how conditional rendering works. I Also got great rehearse on using GitHub Pages because of our deployment issues. Merging and using branches as a team became much more clear. I'm now more confident in using these techniques during our project course.
